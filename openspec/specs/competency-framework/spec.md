...
Versioned skills/competency frameworks with activity-to-competency mapping, automatic evidence from trusted completions, manual evidence behind approval, learner profiles, and gap analysis against target frameworks — kept strictly separate from academic and monetary records.
## Requirements
