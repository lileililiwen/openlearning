# surveys-polls Specification

## Purpose

Non-graded instructor/admin-authored surveys and polls with four question types, response windows, one-response enforcement, structural anonymity, and policy-gated aggregate results — for course feedback, live polling, and quick checks.
## Requirements
