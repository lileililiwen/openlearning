...
builder.Services.AddCreditsModule();
...
builder.Services.AddPeerAssessmentModule();
builder.Services.AddCompetencyModule();
builder.Services.AddGradebookModule();
builder.Services.AddSurveysModule();
