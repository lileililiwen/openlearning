...
{
    /// <inheritdoc />
    public partial class AddCouponIO : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "CouponImportJobs",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CouponImportJobs", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "CouponImportRowErrors",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CouponImportRowErrors", x => x.Id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_CouponImportJobs_AsyncIOJobId",
                table: "CouponImportJobs",
                column: "AsyncIOJobId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CouponImportJobs_UserId_CreatedAt",
                table: "CouponImportJobs",
                columns: new[] { "UserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_CouponImportRowErrors_JobId",
                table: "CouponImportRowErrors",
                column: "JobId");
        }
