...
public class NotificationService
{
    ...
    private static readonly Dictionary<string, (NotificationType Type, string Title, string Body)> _events =
        new()
        {
            ...
            [EventKeys.PeerReviewOpened] = (NotificationType.PeerReviewOpened, "Peer review open", "The peer review phase has opened and submissions are waiting for your assessment."),
            [EventKeys.PeerReviewResultsReleased] = (NotificationType.PeerReviewResultsReleased, "Peer review results released", "Your peer review results are now available."),
        };
